...
namespace AppTask.Controllers
{
    public class ProjetoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Nome,Descricao,DataInicio,DataFim")] Projeto projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Nome,Descricao,DataInicio,DataFim")] Projeto projeto)
        {
