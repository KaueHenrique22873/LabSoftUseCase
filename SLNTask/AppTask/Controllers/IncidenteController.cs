...
namespace AppTask.Controllers
{
    public class IncidenteController : Controller
    {
        ...
        {
            var dbTasksContext = _context.Incidentes.Include(i => i.Funcionario);
        ...
        public async Task<IActionResult> Create([Bind("Codigo,DescricaoProblema,DataIncidente,Solucao,Resolvido,FuncionarioId")] Incidente incidente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,DescricaoProblema,DataIncidente,Solucao,Resolvido,FuncionarioId")] Incidente incidente)
        {
